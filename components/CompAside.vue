            ...
            <div class="col-12">
              ...
              <div class="form-check">
                <input
                  ...
                  id="hotelType3"
                />
                <label class="form-check-label" for="hotelType3"
                  >Apartment</label
                >
              </div>
              <!-- Checkbox -->
              ...
              <div class="multi-collapse collapse" id="hotelType">
                ...
                <div class="form-check">
                  <input
                    ...
                    id="hotelType7"
                  />
                  <label class="form-check-label" for="hotelType7"
                    >Guest House</label
                  >
                </div>
                <!-- Checkbox -->
                <div class="form-check">
                  <input
                    ...
                    id="hotelType10"
                  />
                  <label class="form-check-label" for="hotelType10"
                    >Cottage</label
                  >
                </div>
                <!-- Checkbox -->
                <div class="form-check">
                  <input
                    ...
                    id="hotelType8"
                  />
                  <label class="form-check-label" for="hotelType8"
                    >Beach Hut</label
                  >
                </div>
                <!-- Checkbox -->
                <div class="form-check">
                  <input
                    ...
                    id="hotelType9"
                  />
                  <label class="form-check-label" for="hotelType9"
                    >Farm house</label
                  >
                </div>
              </div>
            ...
            <div class="col-12">
              ...
              <div class="form-check">
                ...
                <label class="form-check-label" for="popolarType3"
                  >Free Cancellation Available</label
                >
              </div>
            </div>
          </div>
